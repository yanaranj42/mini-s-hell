...
#    Updated: 2024/10/17 11:25:24 by yanaranj         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES += built-ins/builtins.c built-ins/env.c built-ins/echo.c built-ins/cd.c built-ins/cd_utils.c built-ins/pwd.c built-ins/exit.c built-ins/export.c built-ins/export_utils.c built-ins/export_utils2.c built-ins/unset.c
